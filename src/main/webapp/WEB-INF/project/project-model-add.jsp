...
<script type="text/javascript" src="${pageContext.request.contextPath}/skin/js/jquery-3.4.1.js"></script>
	<script>
		$(function(){
			$.ajax({
				type:"get",
				url:"${pageContext.request.contextPath}/project/need/projects",
				dataType:"json",
				cache:false,
				success:function(data){
					$(data).each(function(index,elem){
						var option="<option  value='"+elem.pid+"'>"+elem.pname+"</option>";
				...
				success:function(data){
					if(data.status==200){
						theAlert(data.msg,"alert",function(){
							window.location="${pageContext.request.contextPath}/project/forward/project-model";
						});
...
<form id="moduleForm" action="${pageContext.request.contextPath}/module/add" method="post">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<select id="proname" name="proname" onchange="getAnalysisName();">
			<option>请选择---</option>
		</select>
	</td>
</tr>
