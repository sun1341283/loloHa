        ...
        $("#archivesForm").ajaxSubmit(function(data){
            if(data.status==200) {
                theAlert(data.msg,"alert",function(){
                    window.location="${pageContext.request.contextPath}/archives/show";
                });
...
<form id="archivesForm"  action="${pageContext.request.contextPath}/archives/import/archives/data" method="post"  ENCTYPE="multipart/form-data">
