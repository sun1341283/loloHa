...
<script type="text/javascript">
        $(function(){
            ...
            $.ajax({
                type:'GET',
                url:'${pageContext.request.contextPath}/archives/person/archives',
                dataType:'json',
                success:function(employee){
					var position=employee.position;
                    var archives = employee.archives;
                    var dept = employee.dept;
                    var levle = employee.level;
                    $("#pname").val(employee.ename);
                    $("#psex").val(employee.esex);
