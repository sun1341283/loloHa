...
<LINK href="${pageContext.request.contextPath}/${pageContext.request.contextPath}/images/css1.css" type=text/css rel=stylesheet>
<LINK href="${pageContext.request.contextPath}/${pageContext.request.contextPath}/images/newhead.css" type=text/css rel=stylesheet>
...
<script>
    function login(){
    	window.location = ("${pageContext.request.contextPath}/Login?username="+$("#username").val()+"&password="+$("#password").val());
    }
</script>
	<DIV>
		<TABLE cellSpacing=0 cellPadding=0 width=1004 border=0 align="center">
			<TBODY>
				<TR>
					<TD colSpan=6><IMG height=92 alt="" src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/images/crm_1.gif"
						width=345></TD>
					<TD colSpan=4><IMG height=92 alt="" src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/images/crm_2.gif"
						width=452></TD>
					<TD><IMG height=92 alt="" src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/images/crm_3.gif" width=207></TD>
				</TR>
				<TR>
					<TD colSpan=6><IMG height=98 alt="" src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/images/crm_4.gif"
						width=345></TD>
					<TD colSpan=4><IMG height=98 alt="" src="${pageContext.request.contextPath}/${pageContext.request.contextPath}/images/crm_5.gif"
						width=452></TD>
