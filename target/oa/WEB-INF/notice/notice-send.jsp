            ...
            success:function(data){
                if(data.status==200){
                    theAlert(data.msg,"alert",function(){
                        window.location="${pageContext.request.contextPath}/notice/show";
                    });
                }else {
...
<form id="noticeForm" id="form12" action="${pageContext.request.contextPath}/notice/add" method="post">
