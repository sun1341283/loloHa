                ...
                success:function (data) {
                    $(data).each(function (index,elem) {
                        var tr = "<tr align='center' bgcolor=\"#FFFFFF\" onMouseMove=\"javascript:this.bgColor='#FCFDEE';\" onMouseOut=\"javascript:this.bgColor='#FFFFFF';\" height=\"22\" >\n" +
                            ...
                            "\t<td>"+elem.pid+"</td>\n" +
                            "\t<td align=\"left\"><a href=''><u>"+elem.pname+"</u></a></td>\n" +
                            "\t<td>中国农业银行</td>\n" +
                            "\t<td>"+elem.comper+"</td>\n" +
                            "\t<td>"+'hello'+"</td>\n" +
                            "\t<td>"+elem.empcount+"</td>\n" +
                            "\t<td>"+elem.starttime+"</td>\n" +
                            "\t<td>"+elem.buildtime+"</td>\n" +
                            "\t<td>"+elem.endtime+"</td>\n" +
                            "\t<td>"+elem.remark+"</td>\n" +
                            "\t<td>"+'编辑'+"</td>\n" +
                            "</tr>";
...
<tr>
 <td height="26" background="skin/images/newlinebg3.gif">
  ...
  <td>
    <input type='button' class="coolbg np" onClick="location='${pageContext.request.contextPath}/project/forward/project-base-add';" value='添加新项目' />
 </td>
 </tr>
</table>
</td>
...
<table id="mytable" width="98%" border="0" cellpadding="2" cellspacing="1" bgcolor="#D1DDAA" align="center" style="margin-top:8px">
<tr bgcolor="#E7E7E7">
